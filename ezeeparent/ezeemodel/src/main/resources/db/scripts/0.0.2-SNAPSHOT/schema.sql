...
CREATE TABLE IF NOT EXISTS EZEE_PROJECT_ITEM_DETAIL_TO_RESOURCE_MAPPING (
	ITEM_DETAIL_ID INTEGER NOT NULL,
	RESOURCE_ID INTEGER NOT NULL,
	FOREIGN KEY (ITEM_DETAIL_ID) REFERENCES EZEE_PROJECT_ITEM_DETAIL(ID),
	FOREIGN KEY (RESOURCE_ID) REFERENCES EZEE_PAYEE(ID),
	PRIMARY KEY(ITEM_DETAIL_ID,RESOURCE_ID)
);
