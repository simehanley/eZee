...
public class EzeeLeaseMetaDataGrid extends EzeeLeaseSubComponentGrid<EzeeLeaseMetaData> {
	...
	public EzeeLeaseMetaDataGrid(EzeeUser user, EzeeEntityCache cache, int pageSize, boolean disableContextMenu,
	...
	public void viewEntity() {
		EzeeLeaseMetaData entity = getSelected();
		if (entity != null) {
			new EzeeCreateUpdateDeleteLeaseMetaData(cache, this, entity, view, LEASE_META_DATA_CRUD_HEADERS).show();
		}
	}
